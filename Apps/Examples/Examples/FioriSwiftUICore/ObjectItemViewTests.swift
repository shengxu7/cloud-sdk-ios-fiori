...
struct ObjectItemViewTests: View {
    ...
    var body: some View {
        NavigationView {
            ...
            .subtitleStyle(TextStyle().italic().lineLimit(1))
        }
    }
}
...
struct ObjectItemViewTests_Previews: PreviewProvider {
...
extension Person: ObjectItemModel {
    var title: String {
